...
const modal_penguji_ranting = () => {
    ...
    // state
    const { setDataPengujiRanting, action, idPengujiRanting } = useContext(globalState)
    ...
    const handleVerification = (e) => {
        ...
        axios.patch(BASE_URL + `penguji/verification/${idPengujiRanting}`, {}, { headers: { Authorization: `Bearer ${token}` } })
            .then(res => {
                setShowModalPengujiRanting(false)
                getDataPengujiRanting()
                // console.log(res.data.data.message);
