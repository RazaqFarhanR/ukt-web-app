...
const penguji = () => {
    ...
    const getDataPenguji = () => {
        ...
        axios.get(BASE_URL + `penguji/count/penguji/role`, { headers: { Authorization: `Bearer ${token}` } })
            .then(res => {
                        ...
                        <div className="grid grid-cols-2 gap-x-5">
                                    ...
                                    return (
                                        <Link href={'./cabang/penguji_cabang'} className="bg-navy hover:bg-gradient-to-r from-[#16D4FC] to-[#9A4BE9] rounded-md p-0.5">
                                            ...
                                            <div className="bg-navy p-5 rounded-md space-y-5">
                                                ...
                                                <h1 className='text-white text-4xl font-semibold tracking-wider'>{dataPenguji.filter(a => a.id_role === 'penguji cabang').map(item => item.count_active)}</h1>
                                            </div>
                                        </Link>
                                    )
                                } 
                            ...
                            <Link href={'./ranting/penguji_ranting'} className="bg-navy hover:bg-gradient-to-r from-[#16D4FC] to-[#9A4BE9] rounded-md p-0.5">
                                ...
                                <div className="bg-navy p-5 rounded-md space-y-5">
                                    ...
                                    {/* data count and button add data */}
                                    <h1 className='text-white text-4xl font-semibold tracking-wider'>{dataPenguji.filter(item => item.id_role === "penguji ranting").map(item => (
                                        <p>{item.count_active}</p>
                                    ))}</h1>
                                </div>
                            </Link>
                        </div>
