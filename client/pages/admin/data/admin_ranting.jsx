...
const admin_ranting = () => {
    ...
    // state
    const [dataAdminRanting, setDataAdminRanting] = useState ([])
    const [action, setAction] = useState ('')
    const [idAdminRanting, setIdAdminRanting] = useState ('')
    ...
    // funtion get data admin ranting
    ...
    const editModal = (selectedItem) => {
        setShowModalAdminRanting (true)
        setAction ('update')
        setIdAdminRanting (selectedItem.id_user)
    ...
    return (
        <>
                    ...
                    <div className="min-h-full bg-darkBlue p-6">
                        ...
                        <div className="flex justify-between items-center text-white mb-7">
                            ...
                            <div className="flex justify-center items-center gap-x-3">
                                ...
                                <h1 className='text-2xl tracking-wider uppercase font-bold'>Admin Ranting</h1>
                            </div>
            ...
            {/* memanggil modal */}
            <globalState.Provider value={{ showModalAdminRanting, setShowModalAdminRanting, dataAdminRanting, setDataAdminRanting, action, setAction, idAdminRanting, setIdAdminRanting, niw, setNiw, name, setName, ranting, setRanting, username, setUsername, password, setPassword, noWa, setNoWa, role, setRole, foto, setFoto }}>
                <Modal_admin_ranting />
            </globalState.Provider>

            <globalState.Provider value={{ showModalDelete, setShowModalDelete, dataAdminRanting, setDataAdminRanting, action, setAction, idAdminRanting, setIdAdminRanting }}>
                <Modal_delete />
            </globalState.Provider>
        </>
    )
