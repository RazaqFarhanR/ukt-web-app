...
const detail_fisik_jambon = () => {
    ...
    const [ukt, setUkt] = useState ('UKT Jambon')
    ...
    const getDataStandartFisik = () => {
        ...
        axios.get (BASE_URL + `standar_fisik/jenis_latihan/UKT Jambon`, { headers: { Authorization: `Bearer ${token}`}})
        .then (res => {
...
export default detail_fisik_jambon