...
const detail_fisik_ukcw = () => {
    ...
    const getDataStandartFisik = () => {
        ...
        axios.get(BASE_URL + `standar_fisik/jenis_latihan/${tipe}`, { headers: { Authorization: `Bearer ${token}` } })
            .then(res => {
                    ...
                    <div className="min-h-full bg-darkBlue p-6">
                        ...
                        <div className="flex justify-between items-center text-white mb-7">
                            ...
                            <div className="flex justify-center items-center gap-x-3">
                                ...
                                <h1 className='text-2xl tracking-wider uppercase font-bold'>Fisik - {tipe}</h1>
                            </div>
