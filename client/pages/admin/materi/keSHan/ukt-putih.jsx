...
const ukt_putih = () => {
    ...
    const [tipe_ukt, setTipe_ukt] = useState("UKT Putih")
    ...
    const getSoal = async () => {
        let id_lembar
        //get id soal
        await axios.post(BASE_URL + 'lembar_soal/ukt/UKT Putih', { data: '' }, headerConfig())
            .then(res => {
                console.log(res)
                    ...
                    <div className="min-h-full bg-darkBlue p-6">
                        ...
                        <div className="flex justify-between items-center text-white mb-7">
                            ...
                            <div className="flex justify-center items-center gap-x-3">
                                ...
                                <h1 className='text-2xl tracking-wider'>KESHAN - UKT Putih</h1>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-x-5 text-white mb-5">
                            ...
                            {/* show answer */}
                            <button onClick={() => handleAnswer()} className="bg-gradient-to-l from-[#16D4FC] to-[#9A4BE9] rounded-md p-0.5">
