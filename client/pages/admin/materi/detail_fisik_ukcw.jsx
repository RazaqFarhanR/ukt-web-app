...
const detail_fisik_ukcw = () => {
    const [role, setRole] = useState('')
    useEffect(() => {
        const admin = JSON.parse(localStorage.getItem('admin'))
        setRole(admin.id_role)
    }, [])
    // deklarasi router
    ...
    const [ukt, setUkt] = useState('UKCW')
    ...
    const getDataStandartFisik = () => {
        ...
        axios.get(BASE_URL + `standar_fisik/jenis_latihan/UKCW`, { headers: { Authorization: `Bearer ${token}` } })
            .then(res => {
                    ...
                    <div className="min-h-full bg-darkBlue p-6">
                        ...
                        <div className="flex justify-between items-center text-white mb-7">
                            ...
                            <div className="flex justify-center items-center gap-x-3">
                                ...
                                <h1 className='text-2xl tracking-wider uppercase font-bold'>Fisik - UKCW</h1>
                            </div>
                        ...
                        <div className="grid grid-cols-12 text-green text-center mb-4">
                            ...
                            {role !== 'admin ranting' && <div className="">
                                <h1>Edit</h1>
                            </div>}
                        </div>
                        ...
                        <div className="grid grid-cols-12 place-content-center text-white text-lg text-center gap-x-2 mb-2">
                           ...
                           {role !== 'admin ranting' && <div className="bg-navy rounded-md flex justify-center items-center">
...
export default detail_fisik_ukcw