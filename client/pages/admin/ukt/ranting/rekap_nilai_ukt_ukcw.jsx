                            ...
                            <div className='overflow-x-auto overflow-y-auto h-full bg-navy'>
                                ...
                                <table className='w-full table-fixed min-w-[800px]'>
                                    <thead className='bg-purple '>
                                        <tr className='text-white text-center bg-purple sticky top-0 z-10'>
                                            ...
                                            <th className='text-xs w-[5%] border font-oswald'>Kripen {jenis == 'kripen' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray p-0.5' onClick={() => {
                                                    setJenis('kripen');
                                                    setUpDown('downToUp');
                                            ...
                                            <th className='text-xs w-[6%] border font-oswald bg-purple sticky right-0 z-10'>Rata-rata {jenis == 'all' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray p-0.5' onClick={() => {
                                                    setJenis('all');
                                                    setUpDown('downToUp');
                                    ...
                                    <tbody className=''>
                                        {
                                            dataUkt?.map((item, index) => (
                                                <tr key={index + 1} className={'text-white text-center even:bg-darkBlue border-t border-gray-100 border font-bold text-xs'}>
                                                    ...
                                                    <td
                                                        className={`border-b-2 border-gray border font-bold text-xs sticky right-0 z-0
                                                            ${item?.total < 50
                                                                ? 'bg-[#371b1b]'
                                                                : item?.total > 89.99
                                                                    ? 'bg-[#1f371b]'
