                    ...
                    <div className="relative w-[90%] h-auto max-w-2xl md:h-auto rounded-lg bg-gradient-to-r from-[#16D4FC] to-[#9A4BE9] p-0.5">
                        ...
                        <div className="relative bg-navy text-white rounded-lg shadow px-10">
                            ...
                            <div className="flex items-center py-2 pb-6">
                                <button 
                                    className={`font-lato text-white flex justify-center items-center rounded-lg font-lg px-5 py-3 w-full ${nilai > 0 ? 'bg-gray' : props.loading ? 'bg-purple/70 cursor-not-allowed' : 'bg-purple'}`} 
                                    onClick={props.mulai} 
                                    disabled={nilai > 0 || props.loading}
                                >
                                    {props.loading ? (
                                        <>
