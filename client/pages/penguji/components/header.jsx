        ...
        <>
            <div className="sticky top-0 z-10 header border-b bg-navy shadow shadow-black w-full px-2 py-3 font-lato">
                ...
                {splitLoc == '' && (
                    <button 
                        onClick={() => {
                            localStorage.removeItem('penguji');
                            location.push('/penguji/login');
                        }} 
                        style={{ backgroundColor: '#DC2626' }}
                        className="absolute right-3 top-2 flex items-center justify-center p-2 text-white rounded-full shadow drop-shadow-lg transition duration-300 ease-in-out hover:brightness-110"
                        title="Logout"
                    >
