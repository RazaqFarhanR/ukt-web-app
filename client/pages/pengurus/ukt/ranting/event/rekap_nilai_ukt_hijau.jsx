                                ...
                                <table className='w-full table-fixed min-w-[800px]'>
                                    <thead className='bg-purple sticky top-0'>
                                        <tr className='text-white text-center bg-purple'>
                                            ...
                                            <th className='text-xs w-[6%] border font-oswald'>KESHAN {jenis == 'keshan' && updown == 'upToDown'
                                            ...
                                            <th className='text-xs w-[6%] border font-oswald'>Senam {jenis == 'senam' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray text-xs' onClick={() => {
                                                    setJenis('senam');
                                                    setUpDown('downToUp');
                                            ...
                                            <th className='text-xs w-[6%] border font-oswald'>Jurus {jenis == 'jurus' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray text-xs' onClick={() => {
                                                    setJenis('jurus');
                                                    setUpDown('downToUp');
                                            ...
                                            <th className='text-xs w-[6%] border font-oswald'>Teknik {jenis == 'teknik' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray text-xs' onClick={() => {
                                                    setJenis('teknik');
                                                    setUpDown('downToUp');
                                            ...
                                            <th className='text-xs w-[6%] border font-oswald'>Fisik {jenis == 'fisik' && updown == 'upToDown'
                                                ? <button className='rounded-md bg-gray text-xs' onClick={() => {
                                                    setJenis('fisik');
                                                    setUpDown('downToUp');
