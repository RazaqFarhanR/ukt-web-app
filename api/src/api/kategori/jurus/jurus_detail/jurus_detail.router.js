...
const {
    ...
    controllerGetList,
} = require('./jurus_detail.controller');
...
router.get('/list/:tipe_ukt', Auth, verifyRoles("admin", "super admin", "admin ranting", "admin cabang", "pengurus cabang", "pengurus ranting", "penguji cabang", "penguji ranting"), controllerGetList)
